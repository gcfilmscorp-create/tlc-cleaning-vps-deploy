...
import { i as site, n as cn, r as navLinks, t as Button } from "./site-Cge8Amps.mjs";
import { c as HeadContent, d as Outlet, f as lazyRouteComponent, g as useRouter, h as Link, m as createRootRouteWithContext, p as createFileRoute, s as Scripts, u as createRouter } from "../_libs/@tanstack/react-router+[...].mjs";
import { P as ArrowUp, S as Clock, _ as Instagram, b as Facebook, f as Menu, p as MapPin, t as X, u as Phone } from "../_libs/lucide-react.mjs";
import { a as DialogOverlay, c as DialogTrigger, i as DialogDescription, n as DialogClose, o as DialogPortal, r as DialogContent, s as DialogTitle, t as Dialog } from "../_libs/@radix-ui/react-dialog+[...].mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CEA-rtvm.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DzXqlZ9q.css";
...
var tlc_round_logo_default = "/assets/tlc-round-logo-DiQtNTpR.png";
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-sans text-[0.78em] font-medium tracking-[-0.05em]",
						children: "TLC"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
var $$splitComponentImporter$7 = () => import("./routes-Nc4wPzNK.mjs");
var Route$7 = createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "TLC Cleaning Co. — Professional Cleaning. Peace of Mind." },
		{
			name: "description",
			content: "Dependable residential and commercial cleaning in Massachusetts. Family-owned, fully insured, 15+ years of experience. Request a free estimate today."
		},
		{
			property: "og:title",
...
var $$splitComponentImporter$6 = () => import("./about-xlqD2n4U.mjs");
var Route$6 = createFileRoute("/about")({
	head: () => ({ meta: [
		{ title: "About TLC Cleaning Co. — Cleaning with Care Since 2015" },
		{
			name: "description",
			content: "TLC Cleaning Co. is a family-owned, woman-led cleaning company serving homes and businesses across the North Shore, South Shore, and surrounding Massachusetts communities."
		},
		{
			property: "og:title",
			content: "About TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "Tender, Love and Care — the idea that guides how we approach every space since 2015."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
var $$splitComponentImporter$5 = () => import("./additional-services-cBz_BlAK.mjs");
var Route$5 = createFileRoute("/additional-services")({
	head: () => ({ meta: [
		{ title: "Add-On Cleaning Services & Service Types — TLC Cleaning Co." },
		{
			name: "description",
			content: "Oven, refrigerator, cabinet, window, blind, and fixture cleaning plus laundry folding and custom special projects across Massachusetts."
		},
		{
			property: "og:title",
			content: "Additional Services — TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "Extra care for the details that need it. Add-on services and custom projects."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./commercial-Di4Jgz6H.mjs");
var Route$4 = createFileRoute("/commercial")({
	head: () => ({ meta: [
		{ title: "Commercial Cleaning for Massachusetts Businesses — TLC Cleaning Co." },
		{
			name: "description",
			content: "Reliable commercial cleaning plans tailored to your facility, schedule, and priorities. Daily, weekly, biweekly, or monthly service."
		},
		{
			property: "og:title",
			content: "Commercial Cleaning — TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "A cleaner business makes a stronger impression. Flexible commercial cleaning plans."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./contact-O8PoIPAo.mjs");
var Route$3 = createFileRoute("/contact")({
	head: () => ({ meta: [
		{ title: "Request a Free Cleaning Estimate — TLC Cleaning Co." },
		{
			name: "description",
			content: "Tell us about your home, business, or special project and receive a free, customized cleaning estimate. Call (857) 392-9508."
		},
		{
			property: "og:title",
			content: "Contact TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "A cleaner space starts here. Request your free, no-obligation estimate today."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./faq-C9iIZaZS.mjs");
var Route$2 = createFileRoute("/faq")({
	head: () => ({ meta: [
		{ title: "Frequently Asked Questions — TLC Cleaning Co." },
		{
			name: "description",
			content: "Answers about our cleaning services, recurring plans, free estimates, supplies, eco-friendly options, add-ons, and service areas in Massachusetts."
		},
		{
			property: "og:title",
			content: "Frequently Asked Questions — TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "Everything you need to know before booking your first cleaning with TLC."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./residential-N5EuGcGd.mjs");
var Route$1 = createFileRoute("/residential")({
	head: () => ({ meta: [
		{ title: "Residential Cleaning in Massachusetts — TLC Cleaning Co." },
		{
			name: "description",
			content: "Reliable residential cleaning designed around your home, your priorities, and your schedule. Weekly, biweekly, and monthly plans available."
		},
		{
			property: "og:title",
			content: "Residential Cleaning — TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "A cleaner home and a lighter routine. Personalized residential cleaning in Massachusetts."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./specialized-services-BDBKY65X.mjs");
var Route = createFileRoute("/specialized-services")({
	head: () => ({ meta: [
		{ title: "Deep, Move-Out & Post-Construction Cleaning — TLC Cleaning Co." },
		{
			name: "description",
			content: "Specialized residential cleaning: deep cleaning, move-in / move-out cleaning, and post-construction final cleanup across Massachusetts."
		},
		{
			property: "og:title",
			content: "Specialized Residential Services — TLC Cleaning Co."
		},
		{
			property: "og:description",
			content: "Deep cleaning, move-in / move-out, and post-construction cleanup for spaces that need more than the basics."
		}
	] }),
...
var rootRouteChildren = {
	...
	AdditionalServicesRoute: Route$5.update({
		id: "/additional-services",
		path: "/additional-services",
		getParentRoute: () => Route$8
	}),
	CommercialRoute: Route$4.update({
		id: "/commercial",
		path: "/commercial",
		getParentRoute: () => Route$8
	}),
