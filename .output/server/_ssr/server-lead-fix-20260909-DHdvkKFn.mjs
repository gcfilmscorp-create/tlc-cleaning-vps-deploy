...
import { t as createCsrfMiddleware } from "./createCsrfMiddleware-lead-fix-20260909-B2To0gPJ.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-lead-fix-20260909-D-ClBzxM.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-lead-fix-20260909-BCircyj0.mjs"),
		import("./start-lead-fix-20260909-BzYx1gMl.mjs"),
		import("./empty-plugin-adapters-lead-fix-20260909-D9UWiqvJ.mjs")
	]);
	return {
		routerEntry,
		startEntry,
